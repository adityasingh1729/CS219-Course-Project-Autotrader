...
int main() {
    ...
    // std::string line;
    // std::vector<std::string> orders1;
    // std::vector<std::string> orders2;

    // std::ifstream market1("market1.txt");
    // std::ifstream market2("market2.txt");
    // while (getline(market1, line)) {
    //     orders1.push_back(line);
    // }
    // while (std::getline(market2, line)) {
    //     orders2.push_back(line);
    // }
    // std::cout << orders1[0] << std::endl;
